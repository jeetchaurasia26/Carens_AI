...
export const HorizonHeroSection = () => {
  ...
  return (
    <div ref={containerRef} className="hero-container cosmos-style h-[100vh] sticky top-0">
      ...
      <div className="hero-content cosmos-content">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          <p className="subtitle-line font-light">
            The Intelligence Layer
          </p>
          <p className="subtitle-line font-bold">
      ...
      <div ref={scrollProgressRef} className="scroll-progress hidden" style={{ visibility: 'hidden' }}>
      </div>
       ...
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              ...
              line2: 'Behind Modern Lending'
            },
            1: {
              line1: 'Beyond the boundaries of limits,',
              line2: 'lies the universe of growth'
            },
            2: {
              line1: 'In the space between thought and creation,',
              line2: 'we automate true innovation'
            }
          };
          ...
          return (
            <section key={i} className="content-section">
              ...
              <div className="hero-subtitle cosmos-subtitle opacity-0">
