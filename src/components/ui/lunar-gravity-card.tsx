...
export default function LunarGravityCard({ 
  ...
  title = (
    <>
      <span className="text-zinc-50 drop-shadow-sm">Limitless</span>
      <br />
  ...
  description = "Manage millions of loan portfolios effortlessly. Our high-performance infrastructure ensures zero downtime, fully automated workflows, and flawless execution."
