...
export default function Home() {
  ...
  return (
    <main className="min-h-screen font-sans bg-transparent selection:bg-white selection:text-black overflow-x-hidden">
      {/* Dynamic Navigation */}
      <motion.nav
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      {/* The 3D WebGL Background Canvas */}
      <Experience />

      {/* The standard HTML scrolling layout over the top */}
